...
class EducationalDataGenerator:
    def __init__(self, output_dir: str = 'edu_data'):
        ...
        self.group_to_department = {}  # Новый словарь для связи групп и факультетов
    ...
    def _init_realistic_data(self):
        ...
        # Список факультетов (240 уникальных)
        self.faculty_names = [
            'Факультет информационных технологий', 'Экономический факультет', 'Юридический факультет',
            'Физико-математический факультет', 'Факультет иностранных языков', 'Факультет журналистики',
            'Факультет психологии', 'Факультет биологии', 'Факультет химии',
            'Факультет физики', 'Факультет истории', 'Факультет социологии',
            'Факультет политологии', 'Факультет философии', 'Факультет менеджмента',
            'Факультет государственного управления', 'Факультет педагогики', 'Факультет медицины',
            'Факультет стоматологии', 'Факультет фармации', 'Факультет экологии',
            'Факультет географии', 'Факультет геологии', 'Факультет архитектуры',
            'Факультет дизайна', 'Факультет искусств', 'Факультет музыки',
            'Факультет театра', 'Факультет туризма', 'Факультет физической культуры',
            'Факультет прикладной математики', 'Факультет вычислительной техники', 'Факультет робототехники',
            'Факультет электроники', 'Факультет энергетики', 'Факультет машиностроения',
            'Факультет авиации', 'Факультет космонавтики', 'Факультет материаловедения',
            'Факультет нанотехнологий', 'Факультет статистики', 'Факультет международных отношений',
            'Факультет востоковедения', 'Факультет права', 'Факультет рекламы и связей с общественностью',
            'Факультет логистики', 'Факультет пищевых технологий', 'Факультет агрономии',
            'Факультет ветеринарии', 'Факультет зоотехнии', 'Факультет лесного хозяйства',
            'Факультет рыбного хозяйства', 'Факультет землеустройства', 'Факультет строительства',
            'Факультет транспорта', 'Факультет связи', 'Факультет безопасности',
            'Факультет управления качеством', 'Факультет педагогики и психологии', 'Факультет компьютерных наук',
            'Факультет прикладной информатики', 'Факультет лингвистики', 'Факультет социальных наук',
            'Факультет управления проектами', 'Факультет биомедицинских технологий', 'Факультет землеустройства и кадастра',
            'Факультет пищевой инженерии', 'Факультет цифровых технологий', 'Факультет транспортных систем',
            'Факультет урбанистики', 'Факультет педагогического образования', 'Факультет физической реабилитации',
            'Факультет спортивного менеджмента', 'Факультет музыкального искусства', 'Факультет театрального искусства',
            'Факультет изобразительных искусств', 'Факультет экотехнологий', 'Факультет биотехнологий',
            'Факультет химической инженерии', 'Факультет вычислительной математики', 'Факультет искусственного интеллекта',
            'Факультет цифровой экономики', 'Факультет управления данными', 'Факультет кибербезопасности',
            'Факультет инженерной физики', 'Факультет материалов и технологий', 'Факультет медицинской биохимии',
            'Факультет фармакологии', 'Факультет молекулярной биологии', 'Факультет генетики',
            'Факультет нейротехнологий', 'Факультет когнитивных наук', 'Факультет педагогической психологии',
            'Факультет дошкольного образования', 'Факультет начального образования', 'Факультет специальной педагогики',
            'Факультет коррекционной педагогики'
        ]
        
        # Список российских университетов (40)
        russian_universities = [
            ...
            ('Санкт-Петербургский политехнический университет Петра Великого', 'Санкт-Петербург', 'Россия', 1899),
            ('Российский университет дружбы народов (РУДН)', 'Москва', 'Россия', 1960),
            ('Московский государственный технический университет гражданской авиации', 'Москва', 'Россия', 1971),
            ('Московский государственный лингвистический университет', 'Москва', 'Россия', 1930),
            ('Финансовый университет при Правительстве РФ', 'Москва', 'Россия', 1919),
            ('Российский государственный гуманитарный университет', 'Москва', 'Россия', 1991),
            ('Московский педагогический государственный университет', 'Москва', 'Россия', 1872),
            ('Санкт-Петербургский государственный экономический университет', 'Санкт-Петербург', 'Россия', 1930),
            ('Санкт-Петербургский государственный электротехнический университет «ЛЭТИ»', 'Санкт-Петербург', 'Россия', 1886),
            ('Санкт-Петербургский горный университет', 'Санкт-Петербург', 'Россия', 1773),
            ('Балтийский федеральный университет им. И. Канта', 'Калининград', 'Россия', 1947),
            ('Алтайский государственный университет', 'Барнаул', 'Россия', 1973),
            ('Омский государственный университет им. Ф.М. Достоевского', 'Омск', 'Россия', 1974),
            ('Южно-Уральский государственный университет', 'Челябинск', 'Россия', 1943),
            ('Башкирский государственный университет', 'Уфа', 'Россия', 1909),
            ('Белгородский государственный университет', 'Белгород', 'Россия', 1876),
            ('Волгоградский государственный университет', 'Волгоград', 'Россия', 1980),
            ('Иркутский государственный университет', 'Иркутск', 'Россия', 1918),
            ('Кемеровский государственный университет', 'Кемерово', 'Россия', 1973),
            ('Мордовский государственный университет им. Н.П. Огарёва', 'Саранск', 'Россия', 1957)
        ]
        
        # Список зарубежных университетов (40)
        foreign_universities = [
            ...
            ('Тартуский университет', 'Тарту', 'Эстония', 1632),
            ('Вильнюсский университет', 'Вильнюс', 'Литва', 1579),
            ('Латвийский университет', 'Рига', 'Латвия', 1919),
            ('Карагандинский государственный университет им. Е.А. Букетова', 'Караганда', 'Казахстан', 1972),
            ('Гомельский государственный университет им. Ф. Скорины', 'Гомель', 'Беларусь', 1930),
            ('Massachusetts Institute of Technology (MIT)', 'Cambridge', 'США', 1861),
            ('Stanford University', 'Stanford', 'США', 1885),
            ...
            ('ETH Zurich', 'Цюрих', 'Швейцария', 1855),
            ('Technical University of Munich', 'Мюнхен', 'Германия', 1868),
            ('University of Toronto', 'Торонто', 'Канада', 1827),
            ('National University of Singapore', 'Сингапур', 'Сингапур', 1905),
            ('Seoul National University', 'Сеул', 'Южная Корея', 1946),
            ('Australian National University', 'Канберра', 'Австралия', 1946),
            ('University of Cambridge', 'Кембридж', 'Великобритания', 1209),
            ('Princeton University', 'Принстон', 'США', 1746),
            ('Yale University', 'Нью-Хейвен', 'США', 1701),
            ('Columbia University', 'Нью-Йорк', 'США', 1754),
            ('University of California, Berkeley', 'Беркли', 'США', 1868),
            ('California Institute of Technology (Caltech)', 'Пасадена', 'США', 1891),
            ('University of Edinburgh', 'Эдинбург', 'Великобритания', 1582),
            ('University of Copenhagen', 'Копенгаген', 'Дания', 1479),
            ('University of Helsinki', 'Хельсинки', 'Финляндия', 1640),
            ('Sapienza University of Rome', 'Рим', 'Италия', 1303),
            ('University of Barcelona', 'Барселона', 'Испания', 1450),
            ('University of Vienna', 'Вена', 'Австрия', 1365),
            ('Charles University', 'Прага', 'Чехия', 1348),
            ('University of Warsaw', 'Варшава', 'Польша', 1816),
            ('University of Amsterdam', 'Амстердам', 'Нидерланды', 1632),
            ('University of Oslo', 'Осло', 'Норвегия', 1811),
            ('University of Zurich', 'Цюрих', 'Швейцария', 1833)
        ]
        
        # Создаем список университетов (80)
        self.universities_list = []
        for i, (name, city, country, year) in enumerate(russian_universities + foreign_universities, 1):
    ...
    def generate_departments(self):
        ...
        # Перемешиваем список названий для случайного распределения
        faculty_names = self.faculty_names.copy()
        random.shuffle(faculty_names)
        
        # Для каждого университета создаем 3 факультета
        for university in tqdm(self.universities_list, desc="Университеты"):
            university_id = university['university_id']
            
            # Выбираем 3 уникальных названия факультетов
            for j in range(3):
                ...
                faculty_name = faculty_names.pop()
    ...
    def generate_teachers(self, count: int = 2400):
    ...
    def generate_students(self, count: int = 12000):
        ...
        all_groups = self.study_groups.copy()
        random.shuffle(all_groups)
        
        # Распределяем группы по факультетам
        departments = [dept[0] for dept in self.departments]  # список ID факультетов
        
        # Инициализируем словарь для групп факультетов
        department_groups = {dept_id: [] for dept_id in departments}
        
        # Распределяем группы по факультетам
        for dept_id in departments:
            # Каждый факультет получает 1-2 группы
            num_groups = random.randint(1, 2)
            if not all_groups:
                break
            department_groups[dept_id] = [all_groups.pop() for _ in range(min(num_groups, len(all_groups)))]

        # Создаем обратное отображение группы на факультет
        group_to_department = {}
        for dept_id, groups in department_groups.items():
            for group in groups:
                group_id = group[0]
                group_to_department[group_id] = dept_id
        
        # Для оставшихся групп (если есть) распределяем по случайным факультетам
        for group in all_groups:
            ...
            department_groups[dept_id].append(group)
        
        # Сохраняем распределение студентов по факультетам
        self.department_students = {dept_id: 0 for dept_id in departments}
        ...
        for group in tqdm(self.study_groups, desc="Группы"):
            ...
            department_id = group_to_department.get(group_id)
            if department_id is None:
                # Если группа не распределена, выбираем случайный факультет
                department = random.choice(self.departments)
                department_id = department[0]
                group_to_department[group_id] = department_id
    ...
    def generate_courses(self, count: int = 800):
        ...
        # Распределение по факультетам (3-4 на факультет)
        departments_count = {dept[0]: 0 for dept in self.departments}
        
        # Начальное распределение: по 3 курса на факультет
        courses_per_department = {dept_id: 3 for dept_id in departments_count.keys()}
        
        # Добавляем дополнительные курсы (800 - 240*3 = 800-720=80)
        dept_ids = list(departments_count.keys())
        for _ in range(count - len(dept_ids) * 3):
            dept_id = random.choice(dept_ids)
            courses_per_department[dept_id] += 1
        
        course_id = 1
        for dept_id, course_count in tqdm(courses_per_department.items(), desc="Факультеты"):
            department = next(dept for dept in self.departments if dept[0] == dept_id)
            university_id = department[2]
            
            # Выбираем преподавателей этого факультета
            dept_teachers = [t for t in self.teachers if t[9] == dept_id]
    ...
    def generate_schedule(self, count: int = 5000):
        ...
        for course in tqdm(self.courses, desc="Курсы"):
            ...
            for _ in range(min(classes_per_course[course_id], 10)):  # Ограничим максимум 10 занятий на курс
    ...
    def generate_grades(self, count: int = 40000):
        ...
        grade_id = 1
        for enrollment in tqdm(random.sample(self.enrollments, min(count, len(self.enrollments))), desc="Генерация оценок"):
    ...
    def generate_all_data(self):
        ...
        self.generate_universities()           # 80 университетов
        self.generate_study_groups(400)        # 400 групп
        self.generate_departments()            # 240 факультетов
        self.generate_teachers(2400)           # 2400 преподавателей
        self.assign_department_heads()
        self.generate_students(12000)          # 12000 студентов
        self.generate_courses(800)             # 800 курсов
        self.generate_schedule(5000)           # 5000 занятий
        self.generate_enrollments(40000)       # 40000 зачислений
        self.generate_grades(40000)            # 40000 оценок
        self.generate_attendance(120000)       # 120000 посещений
        self.generate_assignments(2000)        # 2000 заданий
        self.generate_assignment_grades(40000) # 40000 оценок за задания
